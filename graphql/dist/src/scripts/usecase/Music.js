...
var Music = /** @class */ (function () {
    ...
    Music.prototype.getMusicList = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.music.getAll()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Music.prototype.findByAlbumId = function (albumId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.music.findByAlbumId(albumId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Music.prototype.findByArtistId = function (artistId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.music.findByArtistId(artistId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
